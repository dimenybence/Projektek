        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionStartedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DefaultSecondsPerQuestion = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuizParticipations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuizParticipations_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuizParticipantAnswers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuizParticipantAnswers_QuizAnswerOptions_AnswerOptionId",
                        column: x => x.AnswerOptionId,
                        principalTable: "QuizAnswerOptions",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_QuizParticipantAnswers_QuizParticipations_ParticipationId",
                        column: x => x.ParticipationId,
                        principalTable: "QuizParticipations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuizParticipantAnswers_QuizQuestions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "QuizQuestions",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizParticipantAnswers_AnswerOptionId",
                table: "QuizParticipantAnswers",
                column: "AnswerOptionId");

            migrationBuilder.CreateIndex(
                name: "IX_QuizParticipantAnswers_ParticipationId_QuestionId",
                table: "QuizParticipantAnswers",
                columns: new[] { "ParticipationId", "QuestionId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_QuizParticipantAnswers_QuestionId",
                table: "QuizParticipantAnswers",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_QuizParticipations_AppUserId",
